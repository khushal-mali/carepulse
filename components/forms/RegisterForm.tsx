      ...
      >
        ...
        <div className="flex flex-col gap-6 xl:flex-row">
          <CustomFormField
            ...
            name="email"
            label="Email address"
            placeholder="Ex: khushal747@gmail.com"
        ...
        <div className="flex flex-col gap-6 xl:flex-row">
          <CustomFormField
            ...
            name="address"
            label="Address"
            placeholder="Ex: 1st Floor, Rang Arcade"
          />
